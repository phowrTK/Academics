                                    ...
                                    <div class="card-body">
                                        ...
                                        <div>
                                            <div class="input-group">
                                                ...
                                                <input placeholder="name" name="name" value="{{ $User->name }}" type="text"
                                                    class="form-control">
                                            </div>
                                            <br>
                                            <div class="input-group">
                                            ...
                                            <br>
                                            <div class="input-group">
                                                <div class="input-group-prepend"><span class="input-group-text">Số điện
                                                        thoại</span></div>
                                                <input placeholder="name" name="phone" value="{{ $User->phone }}"
                                                    type="text" class="form-control">
                                            </div>
                                            <br>
                                            <div class="input-group">
                                                <div class="input-group-prepend"><span class="input-group-text">Địa
                                                        chỉ</span></div>
                                                <input placeholder="name" name="address" value="{{ $User->address }}"
                                                    type="text" class="form-control">
                                            </div>
                                            <br>
                                            ...
                                            <div class="input-group">
                                                ...
                                                <div class="input-group-prepend"><span class="input-group-text">Mật khẩu
                                                        mới</span></div>
                                            ...
                                            <br>
                                            <div class="input-group">
                                                <div class="input-group-prepend"><span class="input-group-text">Nhập lại mật
                                                        khẩu</span></div>
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="radio" style="margin-left:20px" name="level" value="0"
                                                @if($User->level == 0)
                                                    {{ "checked" }}
                                                @endif
                                                ><p>Học viên</p>
                                                <input type="radio" style="margin-left:20px" name="level" value="2"
                                                @if($User->level == 2)
                                                    {{ "checked" }}
                                                @endif
                                                ><p>Giảng Viên</p>
